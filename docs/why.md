...
before assuming robolabel's annotations help a downstream model.

robolabel produces *measured* conditioning annotations. Whether feeding those
...
1. Do not treat robolabel's annotations as a known training win. They are a
